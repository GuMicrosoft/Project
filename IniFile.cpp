// IniFile.cpp: implementation of the CIniFile class.123
//////////////////////////////////////////////////////////////////////
...
{
	BOOL bExist=IniFile.Open(FilePath+FileName,CFile::shareDenyNone);
	return bExist;
}
...
void CIniFile::SetName(CString File)
{
	FileName=File;
}
